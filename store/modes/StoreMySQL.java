package me.mati.skyblock.store.modes;

import me.mati.skyblock.Main;
import me.mati.skyblock.store.Callback;
import me.mati.skyblock.store.Store;
import me.mati.skyblock.store.StoreMode;
import me.mati.skyblock.utils.Logger;
import me.mati.skyblock.utils.TimeUtil;
import me.mati.skyblock.utils.Timming;
...
public class StoreMySQL implements Store {
    ...
    public StoreMySQL(final String host, final int port, final String user, final String pass, final String name, final String prefix) {
        ...
        }.runTaskTimer(Main.getPlugin(Main.class), 600L, 600L);
    }
